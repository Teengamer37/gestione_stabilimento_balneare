...
public class JdbcParkingAvailabilityQuery implements ParkingAvailabilityQuery {

    private final DataSource dataSource;

    public JdbcParkingAvailabilityQuery(DataSource dataSource) {
    ...
    /**
     * Estrae il numero di parcheggi prenotati in un giorno specifico in una determinata spiaggia
     ...
     */
    @Override
    public BookedParkingSpaces getBookedSpacesForDate(Integer beachId, LocalDate date, TransactionContext context) {
