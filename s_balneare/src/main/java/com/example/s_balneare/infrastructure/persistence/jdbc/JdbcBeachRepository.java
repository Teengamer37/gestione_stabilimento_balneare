...
public class JdbcBeachRepository implements BeachRepository {
    ...
    public JdbcBeachRepository(Connection connection) {
    ...
    private void upsertInventory(Beach beach) throws SQLException {
    ...
    private void upsertServices(Beach beach) throws SQLException {
    ...
    private void upsertParking(Beach beach) throws SQLException {
        ...
        try (PreparedStatement statement = connection.prepareStatement(sql)) {
            try (ResultSet rs = statement.executeQuery()) {
                while (rs.next()) {
                    ...
                    BeachGeneral general = new BeachGeneral(name, description, addressId, telephoneNumber);
                    ...
                    beaches.add(new Beach(id, ownerId, general, null, services, parking, extraInfo, null, active));
                }
            }
        } catch (SQLException e) {
    ...
    public Optional<Beach> findById(int id) {
        ...
        try (PreparedStatement statement = connection.prepareStatement(sql)) {
            ...
            try (ResultSet rs = statement.executeQuery()) {
                ...
                Beach beach = new Beach(id, ownerId, general, inventory, services, parking, extraInfo, seasonIds, active);
