...
public record Address(
    ...
    public Address {
        ...
        if (streetNumber == null || streetNumber.isBlank()) throw new IllegalArgumentException("ERROR: street number cannot be blank");
    ...
    public static class Builder {
        ...
        public Builder zipCode(String val) { zipCode = val; return this; }
