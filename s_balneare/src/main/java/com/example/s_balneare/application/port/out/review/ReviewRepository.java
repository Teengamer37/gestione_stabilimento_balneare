...
import com.example.s_balneare.infrastructure.persistence.jdbc.JdbcReviewRepository;

import java.util.List;
import java.util.Optional;

/**
 * Interfaccia che racchiude tutti i metodi che un Service deve avere per manipolare oggetti di tipo Review.
 * <p>Implementata in:
 *
