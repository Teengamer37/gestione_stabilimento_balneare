...
import com.example.s_balneare.infrastructure.persistence.jdbc.moderation.JdbcReportRepository;

import java.util.List;
import java.util.Optional;

/**
 * Interfaccia che racchiude tutti i metodi che un Service deve avere per manipolare oggetti di tipo Report.<br>
 * Implementata in:
 *
